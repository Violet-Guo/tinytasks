...
class TestingSimulation(unittest.TestCase):
    ...
    def test_one_machine(self):
        ...
        machine = Machine(0, 2, event_handler, task_queue, 0, 0, 0)
        machine.start()
        event_handler.run()
    ...
    def test_map_tasks(self):
        ...
        simulator = Simulator(1, 1, tasks, 0, 0, 0)
    ...
    def test_map_multiple_slots(self):
        ...
        parser = Parser(10, 10)
        tasks = parser.parse_tasks(data_file) 
        simulator = Simulator(1, 2, tasks, 0, 0, 0)
        result = simulator.test_run()
    ...
    def test_map_multiple_machines(self):
        ...
        parser = Parser(10, 10)
        tasks = parser.parse_tasks(data_file)
        simulator = Simulator(2, 1, tasks, 0, 0, 0)
        result = simulator.test_run()
